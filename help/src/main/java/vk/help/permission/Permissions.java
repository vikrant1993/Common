...
public class Permissions {
    ...
    static void log(String message) {
        if (loggingEnabled) Common.INSTANCE.longLog(TAG, message);
    }
     ...
     *                    actions such as permission granted, permission denied, etc.
     */
    public static void check(final Context context, String[] permissions, int rationaleId, Options options, final PermissionHandler handler) {
        String rationale = null;
        try {
            rationale = context.getString(rationaleId);
        } catch (Exception ignored) {

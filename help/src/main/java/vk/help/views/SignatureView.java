...
public class SignatureView extends LinearLayout {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            penColor = typedArray.getColor(R.styleable.signature_penColor, context.getResources().getColor(R.color.blue));
            penSize = typedArray.getDimension(R.styleable.signature_penSize, context.getResources().getDimension(R.dimen.dimen_4dp));
    ...
    class Point {
        ...
        float velocityFrom(Point start) {

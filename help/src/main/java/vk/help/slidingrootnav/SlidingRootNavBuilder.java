package vk.help.slidingrootnav;
...
import vk.help.slidingrootnav.transform.CompositeTransformation;
import vk.help.slidingrootnav.transform.ElevationTransformation;
import vk.help.slidingrootnav.transform.RootTransformation;
import vk.help.slidingrootnav.transform.ScaleTransformation;
import vk.help.slidingrootnav.transform.YTranslationTransformation;
import vk.help.slidingrootnav.util.ActionBarToggleAdapter;
import vk.help.slidingrootnav.util.DrawerListenerAdapter;
import vk.help.slidingrootnav.util.HiddenMenuClickConsumer;
...
import vk.help.R;
import vk.help.slidingrootnav.callback.DragListener;
import vk.help.slidingrootnav.callback.DragStateListener;
...
public class SlidingRootNavBuilder {
    ...
    private ViewGroup getContentView() {
        ...
        if (contentView.getChildCount() != 1) {
            throw new IllegalStateException(activity.getString(R.string.bad_content_view));
        }
        return contentView;
    }
    ...
    private View getMenuViewFor(SlidingRootNavLayout parent) {
        if (menuView == null) {
            if (menuLayoutRes == 0) {
                throw new IllegalStateException(activity.getString(R.string.no_menu_view));
            }

...
import vk.help.crop.callback.CropBoundsChangeListener;
import vk.help.crop.model.CropParameters;
import vk.help.crop.model.ImageState;
import vk.help.crop.task.BitmapCropTask;
import vk.help.crop.util.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.CropView_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.CropView_aspect_ratio_y, DEFAULT_ASPECT_RATIO));

package vk.help.crop.view.widget;
...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioTitle = a.getString(R.styleable.crop_AspectRatioTextView_ratio_title);
        mAspectRatioX = a.getFloat(R.styleable.crop_AspectRatioTextView_ratio_x, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(R.styleable.crop_AspectRatioTextView_ratio_y, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
    ...
    private void applyActiveColor(@ColorInt int activeColor) {
        ...
        ColorStateList textViewColorStateList = new ColorStateList(
                ...
                new int[]{activeColor, ContextCompat.getColor(getContext(), R.color.crop_color_widget)}
        );

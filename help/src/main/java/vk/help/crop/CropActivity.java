...
import vk.help.R;
import vk.help.crop.callback.BitmapCropCallback;
import vk.help.crop.model.AspectRatio;
import vk.help.crop.util.SelectedStateListDrawable;
import vk.help.crop.view.CropImageView;
import vk.help.crop.view.CropView;
import vk.help.crop.view.GestureCropImageView;
import vk.help.crop.view.OverlayView;
import vk.help.crop.view.TransformImageView;
import vk.help.crop.view.widget.AspectRatioTextView;
import vk.help.crop.view.widget.HorizontalProgressWheelView;

public class CropActivity extends MasterActivity {
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        Uri outputUri = intent.getParcelableExtra(Crop.EXTRA_OUTPUT_URI);
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setFreestyleCropEnabled(intent.getBooleanExtra(Crop.Options.EXTRA_FREE_STYLE_CROP, OverlayView.DEFAULT_FREESTYLE_CROP_MODE != OverlayView.FREESTYLE_CROP_MODE_DISABLE));
        ...
        mOverlayView.setCircleDimmedLayer(intent.getBooleanExtra(Crop.Options.EXTRA_CIRCLE_DIMMED_LAYER, OverlayView.DEFAULT_CIRCLE_DIMMED_LAYER));
        ...
        int aspectRationSelectedByDefault = intent.getIntExtra(Crop.Options.EXTRA_ASPECT_RATIO_SELECTED_BY_DEFAULT, 0);
        ArrayList<AspectRatio> aspectRatioList = intent.getParcelableArrayListExtra(Crop.Options.EXTRA_ASPECT_RATIO_OPTIONS);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveWidgetColor = intent.getIntExtra(Crop.Options.EXTRA_UCROP_COLOR_WIDGET_ACTIVE, ContextCompat.getColor(this, R.color.crop_color_widget_background));
        mActiveControlsWidgetColor = intent.getIntExtra(Crop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, R.color.crop_color_active_controls_color));

        mToolbarWidgetColor = intent.getIntExtra(Crop.Options.EXTRA_UCROP_WIDGET_COLOR_TOOLBAR, ContextCompat.getColor(this, R.color.crop_color_toolbar_widget));
        mToolbarCancelDrawable = intent.getIntExtra(Crop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.ic_cross);
        mToolbarCropDrawable = intent.getIntExtra(Crop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ic_done);
        ...
        mLogoColor = intent.getIntExtra(Crop.Options.EXTRA_UCROP_LOGO_COLOR, ContextCompat.getColor(this, R.color.crop_color_default_logo));
        mShowBottomControls = !intent.getBooleanExtra(Crop.Options.EXTRA_HIDE_BOTTOM_CONTROLS, false);
        mRootViewBackgroundColor = intent.getIntExtra(Crop.Options.EXTRA_UCROP_ROOT_VIEW_BACKGROUND_COLOR, ContextCompat.getColor(this, R.color.crop_color_crop_background));
    ...
    private void initiateRootViews() {
        mUCropView = findViewById(R.id.crop);
        ...
        findViewById(R.id.crop_frame).setBackgroundColor(mRootViewBackgroundColor);
    }
    ...
    private void changeSelectedTab(int stateViewId) {
        TransitionManager.beginDelayedTransition(findViewById(R.id.crop_photobox), mControlsTransition);

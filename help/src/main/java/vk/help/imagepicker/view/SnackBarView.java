package vk.help.imagepicker.view;
...
public class SnackBarView extends RelativeLayout {
    ...
    private void init() {
        View.inflate(getContext(), R.layout.imagepicker_snackbar, this);
        if (isInEditMode()) {
            return;
        }
        int height = getContext().getResources().getDimensionPixelSize(R.dimen.height_snackbar);
    ...
    public void setOnActionClickListener(@StringRes int textId, final OnClickListener onClickListener) {
        ...
        btnAction.setOnClickListener(v -> hide(new Runnable() {
            @Override
            public void run() {

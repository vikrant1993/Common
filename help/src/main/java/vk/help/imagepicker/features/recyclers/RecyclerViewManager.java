package vk.help.imagepicker.features.recyclers;
...
import vk.help.R;
import vk.help.imagepicker.adapter.FolderPickerAdapter;
import vk.help.imagepicker.adapter.ImagePickerAdapter;
import vk.help.imagepicker.features.ImagePickerConfig;
import vk.help.imagepicker.features.ReturnMode;
...
import vk.help.imagepicker.view.GridSpacingItemDecoration;
...
import static vk.help.imagepicker.features.IpCons.MAX_LIMIT;
import static vk.help.imagepicker.features.IpCons.MODE_MULTIPLE;
import static vk.help.imagepicker.features.IpCons.MODE_SINGLE;
...
public class RecyclerViewManager {
    ...
    private void setItemDecoration(int columns) {
        ...
        itemOffsetDecoration = new GridSpacingItemDecoration(columns, context.getResources().getDimensionPixelSize(R.dimen.ef_item_padding), false);
    ...
    public boolean isShowDoneButton() {
        return !isDisplayingFolderView() && !imageAdapter.getSelectedImages().isEmpty() && (config.getReturnMode() != ReturnMode.ALL && config.getReturnMode() != ReturnMode.GALLERY_ONLY);
    }
}
